	...
	Algoritmo T2P6
		...
		Definir a, b, c, voto Como Entero
		Definir total Como Real
		
		
		Escribir "Ingrese cual candidato gano"
		Leer candidato
		Escribir "Ingrese el total de votos"
		Leer votos
			...
			SiNo 
				...
				SiNo
					Si b = c y b > a Entonces
						Escribir "Los candidatos 2 y 3 tiene los mismos votos"
					SiNo
						Si a > b Entonces
							Si a > c Entonces
